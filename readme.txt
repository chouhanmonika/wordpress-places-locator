...
Wordpress Places Locator plugin brings advance search features to your Wordpress site. Using Google’s API tools users can search for Real estate, places, listings, events or basically any post type by any given address and get results within a chosen radius. 
...
*   While some plugins allow you to search only by zip code Wordpress places locator let you search by city, zip code or any given form of address.
*	While some plugins search within a zip code database, for a better performance Wordpress places locator build its own locations database.
...
*   When the address entered does not exist the information will not be saved and the user will be asked to enter the address again.
	This is a great feature to guarantee that the address entered is verified.
...
= 1.0 =
* First release - pleas advice for any errors or suggestions.
