=== Wordpress places locator - This plugin is now being developed under new name - GEO my WP ===
Contributors: Ninjew
...
Attention: 
	...
	Wordpress Places Locator is now Being developed under a new name. The latest update includes many changes and new features which the main one is integration with buddypress. 
	Now, when the plugin let you search not only post types or locations but also Buddypress's members i have decided to give it a new name. <strong> <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">GEO my WP</a> </strong> is now the new place of wordpress places locator. 
	...
	if this is your first time installing the plugin all you need to do is install and activate. If you have already been using "Wordpress Places Locator" In order to update your plugin please remove the current "wordpress places locator" plugin from your wordpress plugins folder and keep it in a safe place for a backup. 
	Download the new <strong> <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">GEO my WP</a> </strong> plugin, install and activate. 
