=== Wordpress places locator - This plugin is now being developed under new name - <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">GEO my WP</a> ===
Contributors: Ninjew
...
<strong style="font-size:18px;"> Attention: Attention: Attention: Attention: Attention: Attention: Attention: Attention: Attention: </strong>
	
<strong style="font-size:18px;">Wordpress Places Locator is now Being developed under a new name. 
The latest update includes many changes and new features which the main one is integration with buddypress. 
Now, when the plugin let you search not only post types or locations but also Buddypress's members i have decided to give it a new name.
<a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">GEO my WP</a> is now the new place of wordpress places locator. 
Please go <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">here</a> to download the new GEO my WP plugin which is the next update of wordpress places locator.
if this is your first time installing the plugin all you need to do is install and activate. 
If you have already been using "Wordpress Places Locator" In order to update your plugin 
please remove the current "wordpress places locator" plugin from your wordpress plugins folder and keep it in a safe place for a backup. 
Download the new <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">GEO my WP</a> plugin, install and activate. 
You will not lose any of your data or locations. The only thing you might need to do is to save the settings and the shortcodes again. 
I have put countless hours to improve the plugin , add new features, give a better performance and make it more user friendly. I hope you'll enjoy it!
