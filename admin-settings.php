...
?>	
	<table class="widefat fixed" style="margin-bottom:10px;">
		<tr style="background:#C5D8EB;">
			<td>
			<p style="font-size:20px;line-height: 40px;"><strong style="color:red;">PLease Note! Your plugin wasn't update! </strong> Wordpress Places Locator is now Being developed under a new name. The latest update includes many changes and new features which the main one is integration with buddypress. Now, when the plugin
			let you search not only post types or locations but also Buddypress's members i have decided to give it a new name. 
			<strong style="color:red;">GEO my WP</strong> is now the new place of wordpress places locator. Please go <a href="http://wordpress.org/extend/plugins/geo-my-wp/" target="_black">here</a> to download the new GEO my WP plugin which is the next update of wordpress places locator. 
			In order to update your plugin please remove the current "wordpress places locator" plugin from your wordpress plugins folder and keep it in a safe place for a backup. Download the new "GEO my WP" plugin, install and activate. You will not 
			lose any of your data or locations. The only thing you might need to do is to save the settings and the shortcodes again.
